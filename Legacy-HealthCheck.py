...
# Cisco 2911 Router Connection and Settings
    ...
    time.sleep(1)
    ssh_conn.send(" ping 10.104.0.62 \n")
    time.sleep(1)
    ...
    ssh_conn.send("\n show ip route ospf \n")
    time.sleep(2)
    ssh_conn.send("\n ping 10.243.201.10 repeat 100 source Loopback0 size 1024 \n")
    time.sleep(1)
    ssh_conn.send(" ping 10.243.201.10 repeat 100 source Loopback0 size 1024 \n")
    time.sleep(1)
    ssh_conn.send(" show ip route eigrp \n")
    time.sleep(1)
    ssh_conn.send(" show dmvpn \n")
